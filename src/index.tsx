...
//
// Phase A smoke test: connect to DevMind.McpServer.exe, list tools,
// call list_memory_topics, disconnect, exit.
// Phase B will replace this with the interactive REPL loop.
